...
export const metadata: Metadata = {
  ...
  tags: [],
  httpMethod: 'get',
  httpPath: '/api/v2/statistics/revenue',
  operationId: 'get_api-stats-revenue',
};
...
export const handler = async (client: Haye, args: Record<string, unknown> | undefined) => {
  ...
  return asTextContentResult(await maybeFilter(args, await client.v2.statistics.revenue(body)));
};
