...
export const metadata: Metadata = {
  ...
  tags: [],
  httpMethod: 'post',
  httpPath: '/api/v2/cards/{id}/add-visit',
  operationId: 'post_api-post-card-add-visit',
};
...
export const handler = async (client: Haye, args: Record<string, unknown> | undefined) => {
  ...
  return asTextContentResult(await maybeFilter(args, await client.v2.cards.addVisit(id, body)));
};
